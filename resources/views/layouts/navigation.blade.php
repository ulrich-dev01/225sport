<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('logo/225.png') }}" alt="Logo 225 sport" width="10%">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('communiqué.index')" :active="request()->routeIs('*communiqué*')">
                        {{ __('Communiqué') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('Banière.index')" :active="request()->routeIs('*Banière*')">
                        {{ __('Banière') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('communiqué.index')" :active="request()->routeIs('*communiqué*')">
                {{ __('Communiqué') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('Banière.index')" :active="request()->routeIs('*Banière*')">
                {{ __('Banières') }}
            </x-responsive-nav-link>
        </div>
